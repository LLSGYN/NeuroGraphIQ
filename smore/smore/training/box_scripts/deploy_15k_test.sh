...
#box
python ../main_train.py --do_test --gpus '0' \
 ...
 --checkpoint_path '../logs/FB15k/1p.2p.3p.2i.3i-1p.2p.3p.2i.3i.ip.pi.2u.up/box/g-24.0-mode-(none,0.02)-ngpu-0.1.2.3-os-(500,0,w,wstruct,120)-(0.25,0.25,0.25,0.12,0.12)-dataset-(single,3000,e,True,before)-opt-(aggr,adam,cpu,False,5)-sharen-naive-lr_none/2023.12.09-21:27:41/' \
 $@
