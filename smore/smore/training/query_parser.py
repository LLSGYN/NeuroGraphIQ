...
class QueryDAG(object):
    ...
    # def _instance_merge(self, data: Iterable['QueryDAG']) -> 'QueryDAG':
    #     """
    #     Description:
    ...
    #                 self.ent_out[node][rel] = set.union(self.ent_out[node][rel],
    #                                                     graph.ent_out[node][rel])
    #         self.nodes = set.union(self.nodes, graph.nodes)
...
class MetaManager(object):
    ...
    def reverse_relation(self, rid:int) -> int:
        ...
        if rid < 2 or rid >= len(self.rel_data):
...
class QueryParser(object):
    def __init__(self):
        ...
        self.manager = MetaManager('/home/lousy/smore/data/FB15k')
        # with open(os.path.join('/home/lousy/smore/data/FB15k',
        #                         'ent2id.pkl'), 'rb') as f:
        #     self.ent2id = pkl.load(f)
        # with open(os.path.join('/home/lousy/smore/data/FB15k',
        #                         'rel2id.pkl'), 'rb') as f:
...
if __name__ == '__main__':
    ...
    res = query_parser.parse(query_str)
    print(res)